...
\chapter[Desenvolvimento]{2. Desenvolvimento}
\input{cap2-desen}

\chapter[Materiais e Métodos]{3. Materiais e Métodos}
\input{cap3-metodologia}

\chapter[Resultados]{4. Resultados}
\input{cap4-resultados}

\chapter[Conclusão]{5. Conclusão}
\input{cap5-conclusao}


%\chapter[Lógica Paraconsistente]{2. Lógica Paraconsistente Anotada \\Evidencial $E\tau$}
%\input{cap2-logicaParaconsistente.tex}

%\chapter[Controle Clássico]{3. Controle Clássico}
%\input{cap3-controleClassico}

%\chapter[Sistema Físico]{4. Sistema Físico}
%\input{cap4-sistemaFisico}

%\chapter[Controlador Paraconsistente]{5. Controlador Paraconsistente}
%\input{cap5-paracontrol}

%\chapter[Conclusão]{6. Conclusão}
%\input{cap6-conclusao}
