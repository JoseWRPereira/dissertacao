...
\chapter[Anexo A - Controle clássico de sistemas]{Anexo A - Controle clássico de sistemas}
\newpage
\input{anexoA}

\chapter[Anexo B - Modelo matemático do processo]{Anexo B - Modelo matemático do processo}
\newpage
\input{anexoB}
