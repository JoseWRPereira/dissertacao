...
\nomenclature{$G_{ct}$}{Grau de Contradição}
...
\nomenclature{$G_{it}$}{Grau de Inconsistência}
\nomenclature{$G_{id}$}{Grau de Indefinição}
...
condições \emph{Paracompleto} e \emph{Contradição}, conforme mostrado
...
\nomenclature{$G_{c}$}{Grau de Certeza}
...
\nomenclature{$G_f$}{Grau de Falsidade}
\nomenclature{$G_v$}{Grau de Verdade}
...
exclua os efeitos das incertezas ou contradições \cite{JairJoaoGermano}:
